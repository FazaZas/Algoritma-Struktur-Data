   ...
   while(1) {
     ...
     switch (option) {
      ...
      case 2:    /* add to bottom */
          ...
          printf("Berhasil menambahkan %d di akhir", num);
          printf("\nPress any key to continue...");
          getch();
          break;
      ...
      case 3:    /* Insert After */
          ...
          printf(" Setelah nomor mana yang ingin Anda masukkan : ");
          ...
          if (head != NULL) {
              ...
              printf("%d berhasil ditambahkan setelah %d", num, prev_num);
          }else {
